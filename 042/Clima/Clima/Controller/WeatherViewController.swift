...
class WeatherViewController: UIViewController  {
    ...
    override func viewDidLoad() {
        ...
        // Before get GPS location we need the user allow
...
// The extension adopts the WeatherViewController class with the UITextViewDelegate protocol
...
extension WeatherViewController: CLLocationManagerDelegate {
    func locationManager(_ manager: CLLocationManager, didUpdateLocations locations: [CLLocation]) {
        ...
        // Obtain last element into the array (last = last coordinates, more accurate)
        if let location = locations.last {
            // Stop the location manager, we have all we need
